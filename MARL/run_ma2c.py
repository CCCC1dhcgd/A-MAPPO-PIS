...
def parse_args():
    ...
    parser.add_argument('--model-dir', type=str, required=False,
                        default=r'D:\py_learning\marl_cav_new\MARL_AD_U-20240629T131712Z-001\MARL_AD_U\MARL\results\MAA2C_hard_0', help="pretrained model path")
...
def evaluate(args):
    ...
    rewards, (vehicle_speed, vehicle_position), steps, avg_speeds, PETs, collision_rates = ma2c.evaluation(env, video_dir, len(seeds), is_train=False)
    rewards_mu, rewards_std = agg_double_list(rewards)
