...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "agg_vehicle_type":"highway_env.vehicle.behavior.AggressiveVehicle",
            "def_vehicle_type": "highway_env.vehicle.behavior.DefensiveVehicle",
            "screen_width": 600,  # [px]
    ...
    def step(self, action: Action) -> Tuple[Observation, float, bool, dict]:
        ...
        self.vehicle_pos_full.append([v.position for v in self.controlled_vehicles])
        self.vehicle_pos_full[-1] = [array.tolist() for array in self.vehicle_pos_full[-1]]
        info = {
            ...
            "vehicle_position_full": np.array(self.vehicle_pos_full)
        }
